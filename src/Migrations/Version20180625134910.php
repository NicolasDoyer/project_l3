 ...
 */
final class Version20180625134910 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, tag VARCHAR(6) NOT NULL, name VARCHAR(191) NOT NULL, UNIQUE INDEX UNIQ_C4E0A61F389B783 (tag), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
